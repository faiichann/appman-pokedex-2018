    ...
    return (
      <div style={{ padding: "20px" }}>
           <Card style={{ width: '40rem'  }} onMouseOver={this.show} onMouseOut={this.hide} onClick={() => this.onSelectCard(this.props.item)} >
            <p style={{float:"right",color:"#ec5656"}}>{this.showtext()}</p>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
            ...
            <Grid item xs={6}><p>Str:</p>  </Grid> <Grid item xs={6}><LinearProgress style={{height:'15px',borderRadius:'10px'}} color="secondary" variant="determinate"  value={this.calStrength(this.props.item.attacks)} /></Grid>
            <Grid item xs={6}><p> Weak:</p> </Grid> <Grid item xs={6}><LinearProgress style={{height:'15px',borderRadius:'10px'}} color="secondary" variant="determinate" value={this.calWeak(this.props.item.weaknesses)}/></Grid>
...
//         return (
//             <div style={{ padding: "20px" }}>
//                 <Card style={{ width: '40rem' }} onMouseOver={this.show} onMouseOut={this.hide} onClick={() => this.SelectCard(this.props.item)} >
//                     <p style={{ float: "right", color: "#ec5656" }}>{this.showtext()}</p>
//                     <Card.Body style={{ padding: "5px" }}>
//                         <Grid container spacing={2}>
//                             <Grid item xs={6}>
